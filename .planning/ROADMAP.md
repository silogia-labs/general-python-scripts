...
**Plans**: 3 plans
- [ ] 05-01-PLAN.md — Wave 0 preconditions: scoring_index_map_default conftest fixture + v1.0 default-order golden output JSON (Pitfall G)
...
| 5. Python Trailer Hardening | v1.1 | 0/3 | Not started | - |
