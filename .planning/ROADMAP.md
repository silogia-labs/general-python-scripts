...
- [ ] **Phase 7: Refactor Scaffolding (no-op)** — Extract `iter_rows()` generator + sink abstraction with byte-identical default output.
- [ ] **Phase 8: STREAM-01 NDJSON Output** — `--ndjson` flag, per-row validation against `schema["items"]`, atomic file writes.
...
| 7. Refactor Scaffolding (no-op)     | v1.2 | 0/0 | Not started | —          |
| 8. STREAM-01 NDJSON Output          | v1.2 | 0/0 | Not started | —          |
